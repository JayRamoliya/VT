    ...
    <div className="w-full bg-white py-16 sm:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-red-50 text-[#007BFF] mb-6 border border-red-100 shadow-sm"
        >
        ...
        <div className="flex flex-wrap items-center justify-center gap-3.5 mt-8">
          <Link
            to="/"
            className="bg-[#007BFF] hover:bg-[#b82215] text-white px-6 py-3 rounded-xl text-xs font-bold uppercase tracking-wider transition-all shadow-md flex items-center gap-2"
          >
          ...
          >
            <Boxes className="w-4 h-4 text-[#007BFF]" />
        ...
        <div className="mt-16 pt-12 border-t border-gray-100 text-left">
          <span className="text-xs font-bold uppercase tracking-widest text-[#007BFF] block mb-4 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {quickLinks.map((link) => (
              <Link
                key={link.title}
                to={link.path}
                className="p-4 rounded-2xl border border-gray-200 hover:border-[#007BFF] hover:shadow-md transition-all group bg-gray-50/50 hover:bg-white"
              >
                <div className="flex items-center justify-between">
                  <span className="text-sm font-bold text-[#151616] group-hover:text-[#007BFF] transition-colors">
                    {link.title}
                  </span>
                  <ArrowRight className="w-3.5 h-3.5 text-gray-400 group-hover:text-[#007BFF] group-hover:translate-x-1 transition-all" />
                </div>
