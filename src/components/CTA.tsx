...
export const CTA: React.FC<CTAProps> = ({
  ...
  return (
    <section className="relative bg-[#007BFF] text-white py-16 sm:py-20 overflow-hidden">
      {/* Background Grid */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff12_1px,transparent_1px),linear-gradient(to_bottom,#ffffff12_1px,transparent_1px)] bg-[size:3rem_3rem] opacity-30" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-black/20 backdrop-blur-sm border border-white/10 text-xs font-bold uppercase tracking-wider mb-6 shadow-lg"
        >
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-6 mt-8 text-xs sm:text-sm font-semibold text-white"
        >
          {[
        ...
        >
          <motion.a
            ...
            id="cta-whatsapp-btn"
            className="bg-[#151616] hover:bg-black text-white px-8 py-4 rounded-xl text-sm font-bold uppercase tracking-wider shadow-xl hover:shadow-2xl flex items-center gap-2.5"
          >
          ...
          <motion.button
            ...
            id="cta-quote-btn"
            className="bg-white hover:bg-gray-100 text-[#151616] px-8 py-4 rounded-xl text-sm font-bold uppercase tracking-wider shadow-xl hover:shadow-2xl flex items-center gap-2.5 cursor-pointer"
          >
        ...
        <motion.div
          ...
          className="mt-8 text-xs sm:text-sm text-white/80"
        >
